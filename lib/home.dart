      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            CircleAvatar(radius: 50, backgroundImage: AssetImage(q.imagem)),

            const SizedBox(height: 20),

            Text(q.pergunta, textAlign: TextAlign.center),
              ...
              onPressed: () {
                ...
                if (perguntaAtual < perguntas.length - 1) {
                  ...
                  ScaffoldMessenger.of(
                    context,
                  ).showSnackBar(const SnackBar(content: Text("Fim do quiz!")));
                }
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFFDAD7B5),
